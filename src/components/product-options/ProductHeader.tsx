  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex gap-6 mt-6 md:mt-0 flex-wrap">
        ...
        <span className="inline-flex items-center gap-1.5 bg-purple-500/20 text-purple-600 text-xs font-medium px-2 py-1 rounded-full transform scale-110 md:scale-105">
